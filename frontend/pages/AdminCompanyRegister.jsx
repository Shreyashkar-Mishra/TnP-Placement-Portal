...
export const AdminCompanyRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        setSuccess(
          `Company "${formData.companyName}" registered successfully! They can now log in using ${formData.email}.`,
        );
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            The company representative will use this email to create their
            account.
          </p>
        </div>
